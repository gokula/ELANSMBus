...
class VoodooI2CCSGestureEngineAS : VoodooI2CMultitouchEngineAS {
    OSDeclareDefaultStructors(VoodooI2CCSGestureEngineAS);
private:
    VoodooCSGestureHIDWrapperAS *_wrapper;
    VoodooCSGestureHIPointingWrapperAS *_pointingWrapper;
    CSGestureScrollAS *_scrollHandler;
