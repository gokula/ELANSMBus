...
class VoodooCSGestureHIPointingWrapperAS;

class CSGestureScrollAS : public IOService {
    typedef IOService super;
    OSDeclareDefaultStructors(CSGestureScrollAS);
...
public:
    ...
    VoodooI2CCSGestureEngineAS *_gestureEngine;
