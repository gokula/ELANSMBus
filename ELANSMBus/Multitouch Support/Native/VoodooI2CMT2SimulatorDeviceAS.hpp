...
//#include "../../Dependencies/Headers/libkern/libkern/OSBase.h"
...
class VoodooI2CNativeEngineAS;

class VoodooI2CMT2SimulatorDeviceAS : public IOHIDDevice {
    OSDeclareDefaultStructors(VoodooI2CMT2SimulatorDeviceAS);
...
private:
    ...
    VoodooI2CNativeEngineAS* engine;
