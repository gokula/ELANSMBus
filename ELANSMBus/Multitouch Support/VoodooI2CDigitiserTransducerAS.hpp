...
class VoodooI2CDigitiserTransducerAS : public OSObject {
    OSDeclareDefaultStructors(VoodooI2CDigitiserTransducerAS);
...
public:
    ...
    static VoodooI2CDigitiserTransducerAS* transducer(DigitiserTransducerType transducer_type, IOHIDElement* digitizer_collection);
protected:
private:
};
