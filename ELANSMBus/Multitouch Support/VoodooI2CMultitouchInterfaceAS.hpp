...
class VoodooI2CMultitouchEngineAS;
...
class VoodooI2CMultitouchInterfaceAS : public IOService {
  OSDeclareDefaultStructors(VoodooI2CMultitouchInterfaceAS);
 ...
 public:
    ...
    static SInt8 orderEngines(VoodooI2CMultitouchEngineAS* a, VoodooI2CMultitouchEngineAS* b);
